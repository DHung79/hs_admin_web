...
class CreateEditTaskerForm extends StatefulWidget {
  ...
  final TaskerModel? taskerModel;
  final Function(int, {int? limit}) onFetch;

  const CreateEditTaskerForm({
    Key? key,
    required this.route,
    this.taskerModel,
  ...
  @override
  State<CreateEditTaskerForm> createState() => _CreateEditTaskerFormState();
}

class _CreateEditTaskerFormState extends State<CreateEditTaskerForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _renderError(),
        _buildContent(),
        if (widget.taskerModel != null) _deleteButton(),
      ],
    );
  }
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                widget.taskerModel != null
                    ? 'Chỉnh sửa thông tin người giúp việc'
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 10),
                    child: Text(
                      widget.taskerModel != null ? 'Đồng ý' : 'Thêm',
      ...
      return Wrap(
        children: [
          ...
          _buildInput(
            width: elementWidth,
            title: 'Tên',
            hintText: 'Nhập tên người giúp việc',
        ...
        children: [
          ClipRRect(
            ...
            child: _images.isNotEmpty
                ...
                : widget.taskerModel != null &&
                        widget.taskerModel!.avatar.isNotEmpty
                    ? AbsorbPointer(
                        child: DisplayImage(widget.taskerModel!.avatar),
                      )
                    : Image.asset(
  ...
  _createTasker() async {
    ...
    _taskerBloc.createObject(editModel: _editModel).then(
      (value) async {
        if (_images.isNotEmpty) {
          _taskerBloc.uploadImage(
  ...
  _editTasker() async {
    ...
    _taskerBloc.editObject(editModel: _editModel, id: _editModel.id).then(
      (value) {
        if (_images.isNotEmpty) {
          _taskerBloc.uploadImage(
            image: _images.first.image,
